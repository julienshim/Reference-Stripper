...
/* harmony import */ var _components_ReferenceStripper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/ReferenceStripper */ "./src/components/ReferenceStripper.js");
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_ReferenceStripper__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById("app"));
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  var wordCount = _ref.wordCount,
      size = _ref.size;
  var percentage = wordCount / 30 * 100;
  var radius = size;
  var strokeWidth = radius / 10;
  ...
  var backgroundStyle = {
    strokeDashoffset: strokeDashoffset,
    stroke: wordCount < 30 ? "var(--ash)" : wordCount < 40 ? "var(--peach)" : "transparent"
  };
  var progressStyle = {
    strokeDashoffset: strokeDashoffset,
    stroke: wordCount < 20 ? "var(--blue)" : wordCount < 30 ? "var(--tangerine)" : wordCount < 40 ? "var(--peach)" : "transparent"
  };
  var textStyle = {
    fill: wordCount < 30 ? "var(--ash)" : "var(--peach)"
  };
...
/***/ "./src/components/ReferenceStripper.js":
/*!*********************************************!*\
  !*** ./src/components/ReferenceStripper.js ***!
  \*********************************************/
/*! exports provided: default */
...
function (_React$Component) {
  _inherits(ReferenceStripper, _React$Component);

  function ReferenceStripper(props) {
    var _this;

    _classCallCheck(this, ReferenceStripper);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReferenceStripper).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFlicker", function () {
      _this.setState({
        flicker: true
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleStrip", function (string) {
      var isWriting = true;
      var isQuoting = false;
      var hasClosed = true;
      var stripped = "";
